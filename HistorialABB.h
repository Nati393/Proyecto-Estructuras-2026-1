...
//ABB para el historial de puntajes (punto 19, 20, 21, 22, 23)
class HistorialABB {
private:
    NodoABB* raiz;

    //Inserta recursivamente respetando el orden del ABB
    NodoABB* insertarRec(NodoABB* nodo, string nombre, int puntaje);

    //Recorre inorden para mostrar de menor a mayor puntaje
...
public:
    ...
    //Busca y muestra el mejor puntaje de un detective
